...
import planners.reactive_planner.commonroad_rp.trajectories
...
class CostFunction(ABC):
    ...
    @abstractmethod
    def evaluate(self, trajectory: planners.reactive_planner.commonroad_rp.trajectories.TrajectorySample) -> float:
        """
...
class DefaultCostFunction(CostFunction):
    ...
    def evaluate(self, trajectory: planners.reactive_planner.commonroad_rp.trajectories.TrajectorySample):
        # acceleration costs
